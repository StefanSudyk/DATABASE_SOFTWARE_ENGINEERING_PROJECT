...
if __name__ == '__main__':
    ...
    api.add_resource(PostFavourite, '/postFavourite/<int:id_property>')
    api.add_resource(DeleteFavourite, '/deleteFavoutire/<int:id_property>')
    api.add_resource(GetUserFavourite, '/deleteFavoutire/<int:id_property>')
